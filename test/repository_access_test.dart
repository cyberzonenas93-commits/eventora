import 'package:eventora_app/data/mock/mock_seed.dart';
import 'package:eventora_app/data/repositories/eventora_repository.dart';
import 'package:eventora_app/domain/models/account_models.dart';
import 'package:flutter_test/flutter_test.dart';

void main() {
  group('EventoraRepository access scoping', () {
    test('guests do not see wallet or campaign data', () {
      final repository = EventoraRepository.seeded(firebaseEnabled: false);
